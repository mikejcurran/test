...
// At the beginning of your index.js file or in a separate JS file
...
// Function to show or hide the welcome box
...
// Modify the switchScene function to include the toggle for the welcome box
function switchScene(scene) {
  console.log("Scene switched to: " + scene.data.id);  // Debugging
  stopAutorotate();
  scene.view.setParameters(scene.data.initialViewParameters);
  scene.scene.switchTo();
  startAutorotate();
...
// Ensure the welcome box is visible when the page first loads
toggleWelcomeBox('88-gsab0116');  // Call this with the ID of your opening scene
...
window.switchScene = switchScene;
  ...
  document.getElementById('toggleLongProfile').addEventListener('click', function() {
    var container = document.getElementById('longProfileContainer');
...
// Function to show the map again (you'll need to call this when you want to reopen the map)
function showMap() {
    var mapContainer = document.getElementById('mapContainer');
    mapContainer.style.display = 'block';
    map.invalidateSize(); // This ensures the map renders correctly after being hidden
}
