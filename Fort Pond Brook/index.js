...
(function() {
  ...
  var sceneNameElement = document.querySelector('#titleBar .sceneLinks');
 ...
 var viewerOpts = {
  controls: {
    mouseViewMode: data && data.settings ? data.settings.mouseViewMode : 'drag' // 'drag' is a fallback value
  }
};
...
function toggleprofileFunction() {
  var x = document.getElementById("longProfileContainer");
  if (x.style.display === "none") {
    x.style.display = "block";
  } else {
    x.style.display = "none";
